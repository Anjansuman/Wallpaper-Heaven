...
export default function SignIn({handleClick}: SigninProps) {
    return (
        <div className="flex justify-center items-center min-h-screen px-4">
            <div className="bg-neutral-900 border border-neutral-700 rounded-xl shadow-lg p-8 w-full max-w-md space-y-6 text-white text-center">

                {/* Header */}
                <div className="space-y-2">
                    <span className="h-5 w-full flex justify-end items-center ">
                        <span onClick={handleClick} className="w-4 h-4 bg-red-500 flex justify-center items-center rounded-full text-[12px] hover:text-black transform transition-colors duration-150 cursor-pointer">x</span>
                    </span>
                ...
                {/* Google Button */}
                <button className="flex items-center cursor-pointer justify-center gap-3 bg-white hover:bg-white/80 text-black w-full py-3 rounded-md text-base font-medium transition duration-200">
                ...
                <p className="text-xs text-neutral-500">
                    ...
                    <span className="underline underline-offset-2 cursor-pointer hover:text-white transition">
