...
export default function UpFront() {
    return <div className="w-full text-[#0B2814] relative " >
        ...
        <div className=" h-30 w-fit absolute top-1/2 left-1/12 -translate-y-1/2 flex flex-col gap-y-3 ">
            <div>
                <div className="text-xl md:text-2xl lg:text-4xl xl:text-6xl font-extrabold ">
                    Wallpaper heaven
                </div>
                <div className="text-sm xl:text-xl text-[#E6E0C5] font-bold ">
                    Give your home a heavenly vibe.
                </div>
            </div>
            <div className="w-fit md:py-2 md:px-4 py-1 px-2 text-sm md:text-md font-medium md:rounded-md rounded-sm bg-[#6DA165] hover:bg-[#5e8b57] transition-colors cursor-pointer text-[#E6E0C5] ">
                See our Designs
            </div>
        </div>
    </div>
